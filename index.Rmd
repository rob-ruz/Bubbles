...
# **Atención para el siguiente proceso se debe tener en su carpeta local del proyecto el archivo "Sectores_GICS_BMV" que se encuentra en la carpeta del "Team"
...
# Registros por empresa por año que tengan monthend == 1
global_daily1 %>% 
  mutate(year = year(datadate)) %>% 
  group_by(conm, year) %>% 
